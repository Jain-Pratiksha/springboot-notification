...
@Component
public class EmailNotificationStrategyImpl implements INotificationStrategy {
    ...
    public NotificationResponseDTO notify(NotificationRequestDTO notificationRequestDTO, INotificationGatewayFactory notificationGatewayFactory) {
        return new NotificationResponseDTO(notificationGatewayFactory.sendNotification(notificationRequestDTO), "Message sent via Email");
    }
